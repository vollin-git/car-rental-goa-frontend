  ...
  return (
    ...
    className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
        ...
        <div className='text-white'>
            <h2 className='text-3xl font-medium'>Ride the Sunshine. 🌴</h2>
            <p className='mt-2'>Goa is better in the driver’s seat. Whether you’re cruising the Mandovi promenade in a convertible or weaving through the colorful lanes of Fontainhas on a classic Vespa, we put the keys to the state in your hand.</p>
